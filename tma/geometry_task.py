...
from Projects.TaskMeAnyMath_temp.tma.metadata import MathTemplateMetaData
from task_store import TaskStore
from utils import *
import json
import enum
# from math_metadata import MathTemplateMetaData
...
class AngleSumGenerator(GeoPlanGenerator):
    ...
    def _generate_task(self, task_plan):
        ...
        if problem not in self.all_tasks:
            ...
            return AngleSumGenerator._generate_task(self, task_plan)
